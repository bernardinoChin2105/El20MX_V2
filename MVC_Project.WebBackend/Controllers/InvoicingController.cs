    ...
    public class InvoicingController : Controller
    {
        ...
        public ActionResult Invoice()
        {
            ...
            try
            {
                ...
                var membership = _membershipService.FirstOrDefault(x => x.account.id == account.Id && x.status == SystemStatus.ACTIVE.ToString() && x.role.status == SystemStatus.ACTIVE.ToString());
