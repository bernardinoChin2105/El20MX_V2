        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            try
            {
                ...
                if (NotificationProcessEnabled)
                {
                    ...
                    RecurringJob.AddOrUpdate("CancellationJob_CredentialsCancellation", () => CredentialsCancellationJob.CredentialsCancellation(), "30 * * * *", TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time (Mexico)"));
