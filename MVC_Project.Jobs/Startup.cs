        ...
        public void Configuration(IAppBuilder app)
        {
            ...
            try
            {
                ...
                if (NotificationProcessEnabled)
                {
                    ...
                    RecurringJob.AddOrUpdate("SATJob_SyncBills", () => SATJob.SyncBills(), "*/10 * * * *", TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time (Mexico)"));
                    RecurringJob.AddOrUpdate("BankJob_SyncAccounts", () => BankJob.SyncAccounts(), "*/15 * * * *", TimeZoneInfo.FindSystemTimeZoneById("Central Standard Time (Mexico)"));
